...
public class PathList
{
  ...
  public void setDefaults(){
    ...
    DashboardPath path2 = new DashboardPath("Red 2"
                          , new SequentialCommandGroup(

                            ), csv2);   
    DashboardPath path3 = new DashboardPath("Red 3"
                          , new SequentialCommandGroup(

                            ), csv3);
    DashboardPath path4 = new DashboardPath("Blue 1"
                          , new SequentialCommandGroup(

                            ), csv4);                                                               
    DashboardPath path5 = new DashboardPath("Blue 2"
                          , new SequentialCommandGroup(

                            ), csv5);
    DashboardPath path6 = new DashboardPath("Blue 3"
                          , new SequentialCommandGroup(
